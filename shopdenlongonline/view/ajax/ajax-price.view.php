...
$select_Price =$data['selectPrice'];
//var_dump($select_Price);die;
?>
<!--XỬ lý giao diện của phần Ajax Price-->
<div class="price-<?php echo $minPrice ?>-<?php echo  $maxPrice?>">
    <?php
    foreach ($select_Price as $item){
        ?>
