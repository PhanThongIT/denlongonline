...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <table class="table table-bordered">
            ...
            <tbody>
            <?php
            foreach ($selectMenuParent as $bills)
            {
                ?>
                <tr>
                    ...
                    <td><?= $bills->name ?></td>
                    <td>
                        <a href="editcategories.php?editcate=<?= $bills->id; ?>">
                            <button style="margin-top: 10px;" class="btn btn-lock btn-sm">Sửa Danh Mục</button>
                        </a>
