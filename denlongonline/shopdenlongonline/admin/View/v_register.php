...
<div class="container">
    ...
    <div class="card card-container" style="max-width: 500px;">
        ...
        <form class="form-signin" method="post" >
            ...
            <input type="date" name="birthdate" class="form-control" placeholder="Ngày sinh" required>
            <select name="gender" class="form-control">
                <option value="nữ" selected>Nữ</option>
                <option value="nam">Nam</option>
            </select>
            <input  type="text" id ="phone" name="phone" class="form-control check-phone" placeholder="Điện thoại" required>
            <input type="text" name="address" class="form-control" placeholder="Địa chỉ"  value="" required>
            ...
            <button class="btn btn-lg btn-primary btn-block btn-Register" type="submit" name="btn-Register">Đăng kí
            </button>
        </form><!-- /form -->
