                ...
                <ul>
                    ...
                    <li class="row" style="text-align: center">
                        <div class="col-sm-12 check-url" style="text-align: center">
                            ...
                            <div class="col-sm-12">
                                <input style="text-align: center" type="text" class="input form-control" name="urlproduct" value="<?= $loadUrl->url;?>" id="urlproduct"
                                       required>
                            </div>
                    ...
                    <li style="text-align: center">
                        <div class="col-md-12">
                            <button style="margin-top: 40px;  width: 150px " class="btn btn-success  active "
                                    type="submit" onclick="" name="btn-EditCate"><i class="fa fa-angle-double-right"></i>&nbsp;
