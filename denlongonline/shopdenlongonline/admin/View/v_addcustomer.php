                ...
                <ul>
                    <li class="row">
                        ...
                        <div class="col-sm-6 check-phone">
                            ...
                            <input type="text" name="phone" class="input form-control" id="phone" required>
                    ...
                    <li style="text-align: center">
                        <div class="col-md-12">
                            <button style="margin-top: 40px;  width: 150px " class="btn btn-success  active "
                                    type="submit" onclick="checkEmail()" name="btn-AddCustomer"><i class="fa fa-angle-double-right"></i>&nbsp;
